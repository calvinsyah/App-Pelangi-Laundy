-- 20260713000009_update_dashboard_rpc_neraca_as_of.sql
...
BEGIN
    ...
    SELECT json_build_object(
        ...
        -- TO-DO: Tactical Fix - Neraca (Kas, Piutang, Utang, Modal) dihitung as-of akhir p_periode (kumulatif)
        -- Ini adalah perbaikan sementara sampai sistem `saldo_tahunan` (Tutup Buku) diimplementasikan
